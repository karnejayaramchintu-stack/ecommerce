  ...
  const features = [
    {
      ...
      description:
        "Describe your business in plain English and get a beautiful, custom website instantly with neon-powered design.",
    },
    {
      icon: Zap,
      title: "One-Click Payments",
      description:
        "Pine Labs integration with UPI, cards, EMI, and split payments—no technical setup required.",
    },
    {
      icon: Shield,
      title: "Trust Score Engine",
      description:
        "AI-powered credibility system that builds customer confidence from day one with real-time updates.",
    },
    {
      icon: Smartphone,
      title: "Mobile-First Design",
      description:
        "Every store is optimized for mobile shopping with lightning-fast loading and dark mode support.",
    },
    {
      icon: TrendingUp,
      title: "Live Analytics",
      description:
        "Real-time AI recommendations for inventory, pricing, and marketing campaigns with neon visualizations.",
    },
    {
      icon: MessageCircle,
      title: "Cross-Channel Sync",
      description:
        "Import products from WhatsApp/Instagram and manage everything in one cyberpunk-inspired dashboard.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      quote:
        "The dark mode interface is stunning! Went from Instagram DMs to ₹50K monthly sales in just 2 weeks!",
    },
    {
      name: "Arjun Mehta",
      ...
      quote:
        "Real-time notifications keep me updated instantly. No more WhatsApp chaos!",
    },
    {
      name: "Kavya Patel",
      ...
      quote:
        "The neon trust score helped me compete with established brands immediately. Love the cyberpunk aesthetic!",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Stop losing sales on WhatsApp. Transform your creator business
              into a professional online store with AI-powered website
              generation, real-time analytics, and built-in trust systems—in
              minutes, not weeks.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Millions of talented creators are stuck selling through DMs
              because traditional e-commerce is too complex, expensive, and
              time-consuming.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: "Cost Barriers",
                desc: "₹15K-50K+ for basic Shopify setup, hosting, and payment integration",
                color: "red",
                icon: "₹",
              },
              {
                title: "Technical Complexity",
                desc: "Payment gateways, hosting decisions, domain setup—overwhelming for creators",
                color: "yellow",
                icon: "⚙️",
              },
              {
                title: "Trust Issues",
                desc: "New stores look sketchy—customers hesitate to buy from unknown sellers",
                color: "blue",
                icon: "🛡️",
              },
              {
                title: "Time Investment",
                desc: "Weeks to launch when creators just want to start selling today",
                color: "purple",
                icon: "⏰",
              },
            ].map((problem, index) => (
              <div
                key={index}
                className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 border rounded-xl p-6 shadow-2xl hover:shadow-${
                  problem.color
                }-400/10 transition-all duration-300 hover:-translate-y-1 ${
                  problem.color === "red"
                    ? "border-red-500/30"
              ...
              >
                <div
                  className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 bg-gradient-to-r ${
                    problem.color === "red"
                      ? "from-red-500/20 to-pink-500/20 border border-red-500/30"
                      : problem.color === "yellow"
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our AI transforms simple descriptions into complete e-commerce
              experiences with integrated payments, live data, and professional
              neon-accented design.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              Watch how a simple description becomes a professional online store
              with live data
            </p>
          </div>
              ...
              <div>
                <div className="bg-gray-900/50 border border-gray-700/50 rounded-xl p-6 mb-6 backdrop-blur-md">
                  ...
                  <p className="text-gray-300 italic">
                    "I sell handmade jewelry for young women, price range
                    ₹500-3000, bohemian style, based in Jaipur"
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    {
                      text: "Beautiful jewelry showcase website",
                      icon: CheckCircle,
                      color: "green",
                    },
                    {
                      text: "Pine Labs checkout with UPI/cards",
                      icon: CreditCard,
                      color: "blue",
                    },
                    {
                      text: "Live trust score system activated",
                      icon: Shield,
                      color: "purple",
                    },
                    {
              ...
              <div className="bg-gray-900/50 border border-gray-700/50 rounded-xl p-6 backdrop-blur-md">
                ...
                <div className="bg-gray-800/50 border border-gray-700/30 rounded-lg p-4">
                  <div className="text-sm text-cyan-400 mb-2 font-mono">
                    neocommerce.ai/boho-jewelry-jaipur
                  </div>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of creators who've moved from DMs to professional
            stores with live data insights
          </p>
          ...
          <div className="mt-8 text-gray-400 text-sm">
            No credit card required • Real-time data • Setup in under 5 minutes
            • Cancel anytime
          </div>
        </div>
      </section>
